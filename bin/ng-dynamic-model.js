...
FieldModelForDirective.prototype = {
    ...
    link: function link(scope, $element, attrs, ctrls) {
        if (!attrs['fieldModelFor']) throw new TypeError('field-model-for: missing required attribute "field-model-for"');
        ...
        var setModelValue = modelController.$$setModelValue;

        if (typeof setModelValue === 'undefined') throw new TypeError('field-model-for: an internal ngModel function has changed, please complain loudly to the author.');
